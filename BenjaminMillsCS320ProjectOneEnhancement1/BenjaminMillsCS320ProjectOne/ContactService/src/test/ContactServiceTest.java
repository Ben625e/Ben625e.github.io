...
class ContactServiceTest {
	...
	public void testAppointmentServiceClassRead() {
		...
		ContactService ContactService = new ContactService();
		ContactService.addContact(ID3, "John", "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID4, "John", "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID2, "John", "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID1, "John", "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID5, "John", "Doe", "5555555555", "Test Drive 123");
		...
		for(int i = 1; i < sortedContacts.size(); i++) {
			assertTrue(sortedContacts.get(i-1).getContactID().compareTo(sortedContacts.get(i).getContactID()) < 0);
		}
	}
