...
class AppointmentTest {
	...
	// The following tests test incorrect values sent to the setters
	@Test
	...
	@Test
	public void testAppointmentSetDescriptionTooLong() {
		@SuppressWarnings("deprecation")
		Date futureDate = new Date(2026, 1 ,1);
		Assertions.assertThrows(IllegalArgumentException.class, () -> {
			Appointment Appointment = new Appointment("123456789", futureDate, "This Appointment Pertains to Test Running");
			Appointment.setDescription("This Appointments Description Is Over The Fifty Character Limit");
		});
	}
