...
The above images show the implementation of the read function and accompanying test function in the Appointment portion of the project. This was also implemented for the Contact and Task portions of the project.<br><br><br>
