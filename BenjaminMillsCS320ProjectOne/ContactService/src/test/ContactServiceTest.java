...
class ContactServiceTest {
	...
	// UPDATE DONE 11/24/2025 : Change value checked from ID to first name
	// Tests newly created read function is working as intended
	@Test
	public void testContactServiceClassRead() {
		...
		String first5 = "Homer";
		ContactService ContactService = new ContactService();
		ContactService.addContact(ID3, first1, "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID4, first3, "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID2, first2, "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID1, first5, "Doe", "5555555555", "Test Drive 123");
		ContactService.addContact(ID5, first4, "Doe", "5555555555", "Test Drive 123");
		ArrayList<Contact> sortedContacts = ContactService.readContacts();
